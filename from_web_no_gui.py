...
def buildPresentation():
    ...
    for i in range(0, presentationLength):
        ...
        if do_translation:
            printDescription = ics499_translate(translation_engine, printDescription, dest_language)
            printFact = ics499_translate(translation_engine, printFact, dest_language)
